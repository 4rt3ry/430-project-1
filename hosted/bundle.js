...
var axios_1 = __importDefault(__webpack_require__(425));
var apiInput = document.querySelector("#api-input");
var subBtn = document.querySelector("#api-form");
var content = document.querySelector("#content");
var handleResponse = function (response) {
    var data = JSON.stringify(response.data, undefined, 4);
    var body = document.createElement("p");
    body.innerHTML = "<pre>".concat(data, "</pre>");
    content.innerHTML = "";
...
var setupUI = function () {
    subBtn.addEventListener('submit', function (e) {
        e.preventDefault();
        console.log("Requesting ".concat(apiInput.value));
        axios_1.default.get("/api/".concat(apiInput.value))
            .then(handleResponse);
        return true;
    });
};
